...
See [SSL/TLS](./ssl-tls.md) for certificate concepts and [SSL Certificates in this project](../project/ssl-certificates.md) for generation and troubleshooting.
...
| `docs/theory/ssl-tls.md` | SSL/TLS concepts |
| `docs/project/ssl-certificates.md` | Certificate setup in this project |
